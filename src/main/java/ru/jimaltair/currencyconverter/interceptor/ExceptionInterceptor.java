package ru.jimaltair.currencyconverter.interceptor;
...
public class ExceptionInterceptor implements HandlerInterceptor {
    ...
    private void writeResponse(HttpServletResponse response, Exception ex) throws IOException {
        ...
        response.getWriter().println("<img src=\"image/crying_cat.jpg\" style=\"max-width: 512px; max-height: 512px; width: auto; height: auto;\"/>");
        response.getWriter().println("</body>");
        response.getWriter().println("</html>");
    }
}
